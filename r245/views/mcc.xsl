<xsl:stylesheet version="1.0"
				...
				<script type="text/javascript"><![CDATA[
					...
					function collapseTag( tagId, direction )
					{
						...
						if( done == "false" )
						{
							...
							if( direction == "tags" )
							{
								document.getElementById( tagId + "-plus-minus-tags" ).innerHTML = "<img src='data:image/gif;base64,%3D%3D'/>";
							}
	...
	<xsl:template match="*[@mcc = 'true']//*">
		<div class="push">
			<xsl:choose>
				<xsl:when test=".//*">
					<div class="plus-minus" id="{generate-id()}-plus-minus-tags" onclick="collapseTag('{generate-id(.)}','tags')"><img src="data:image/gif;base64,"/></div>
				</xsl:when>
				<xsl:when test="text()">
					<div class="plus-minus" id="{generate-id()}-plus-minus-tags" onclick="collapseTag('{generate-id(.)}','tags')"><img src="data:image/gif;base64,"/></div>
				</xsl:when>
